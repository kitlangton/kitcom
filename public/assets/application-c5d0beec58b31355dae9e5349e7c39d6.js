...
(function() {
  $(function() {
    ...
    return $(".hide-mail").velocity("transition.slideUpIn", {
      delay: 21100
    });
  });
...
(function() {
  $(function() {
    ...
    $(".glyphicon").hover(function() {
      return $(this).stop(true, true).velocity({
        opacity: 1
      }, {
        duration: 100
      });
    ...
    $(".glyphicon").click(function() {
      if ($hidden) {
        $hidden = false;
        $(this).closest(".link-bar").find(".glyphicon-chevron-down").velocity("transition.flipYOut", {
          duration: 50
        });
        $(this).closest(".link-bar").find(".glyphicon-chevron-up").velocity("transition.slideDownIn", {
          duration: 250
        });
        return $(".link").velocity("transition.slideDownIn", {
          stagger: 65,
          duration: 100,
          drag: true
        });
        ...
        $hidden = true;
        $(this).closest(".link-bar").find(".glyphicon-chevron-up").velocity("transition.flipYOut", {
          duration: 50
        });
        $(this).closest(".link-bar").find(".glyphicon-chevron-down").velocity("transition.slideUpIn", {
          duration: 250
        });
        return $(".link").velocity("transition.slideUpOut", {
          duration: 100,
          drag: true
        });
      }
    });
    return $(".post").hover(function() {
      return $(this).find(".title").stop(true, true).velocity;
    }, function() {
      return $(this).find(".title").stop(true, true).velocity;
    });
  });
...
(function() {
  $(function() {
    ...
    stopLoading = function() {
      ...
      return $("#kit-logo").css("display", "block");
    };
    $("#hidden-images").imagesLoaded(function() {
      return stopLoading();
    });
    onProgress = function(imgLoad, image) {
      alert(image.img.src);
      return $("#grid-container").gridalicious('append', image);
    };
    return $('#hidden-images').imagesLoaded().progress(onProgress);
  });
